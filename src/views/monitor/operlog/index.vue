<template>
  <div class="app-container">
    ...
    <el-table border ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="操作人员" align="center" prop="operName" show-overflow-tooltip sortable="custom" :sort-orders="['descending', 'ascending']" width="110" />
      <el-table-column label="主机" align="center" prop="operIp" width="130" show-overflow-tooltip />
